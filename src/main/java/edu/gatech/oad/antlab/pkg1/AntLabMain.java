 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Nyambura Iruku");
		  toPrint += p1.toString("niruku7");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Katherine McAuliffe");
		  toPrint += p2.toString("kmcauliffe6");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Nishat Firoj");
		  toPrint += p3.toString("nfiroj3");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Mariana Matias");
                  toPrint += p4.toString("mmatias6");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Kathryn Coveny");
                  toPrint += p5.toString("kcoveny3");
